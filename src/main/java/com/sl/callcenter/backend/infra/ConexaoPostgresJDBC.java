 ...
 */
package com.sl.callcenter.backend.infra;
...
public class ConexaoPostgresJDBC implements ConexaoJDBC {
    ...
    public ConexaoPostgresJDBC() throws ClassNotFoundException, SQLException {
        ...
        this.connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/mydb?Applicationname=HelpMe", properties);
